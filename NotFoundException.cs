...
namespace ExceptionMiddleware
{
    public class NotFoundException : InvalidRestOperationException
    {
        ...
        public NotFoundException(int id, string typeName, string customError, string additionalMessage = "", Exception innerException = null)
            : this(id.ToString(), typeName, customError, additionalMessage, innerException) { }

        public NotFoundException(string id, string typeName, string customError, string additionalMessage = "", Exception innerException = null)
